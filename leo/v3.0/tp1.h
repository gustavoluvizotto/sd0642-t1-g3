...
#define MASTER_SEND_START_CLIENT1 4 /* envio de dados para o client1 */
#define MASTER_SEND_START_CLIENT2 5 /* envio de dados para o client2 */
#define MASTER_SEND_START_CLIENT3 6 /* envio de dados para o client3 */
#define MASTER_SEND_START_CLIENT4 7 /* envio de dados para o client4 */
#define MASTER_SEND_START_CLIENT5 8 /* envio de dados para o client5 */
#define MASTER_SEND_START_CLIENT6 9 /* envio de dados para o client6 */
#define MASTER_SEND_START_CLIENT7 10 /* envio de dados para o client7 */
#define MASTER_SEND_START_CLIENT8 11 /* envio de dados para o client8 */
