...
int main(void){
	...
	char tcom[10];							/* tempo de comunicacao e total */
        ...
        port_number_send = 57534; 	/* porta de comunicacao para envio do vetor */
        host = "elektra";         	/* host que o client 7 e 8 irao se comunicar */
...
/*-----------------recebendo o vetor do servidor principal----------------------------------------------*/
        port_number_receive = 57541;                   	/* numero da porta que recebe do servidor principal*/
