...
int main(void){
	...
	char tcom[10];							/* tempo de comunicacao */
        ...
        port_number_send = 57532;	/* porta de comunicacao para envio do vetor */
        host = "vampira";        	/* host que o client 3 e 4 irao se comunicar */
...
/*-----------------recebendo o vetor do servidor principal----------------------------------------------*/
        port_number_receive = 57539;                   	/* numero da porta que recebe do servidor principal*/
